...
| مدیریت | شیفت‌ها (`#shiftsTable`) | **اسکرول + ستون چسبان** | شبکهٔ روزهای هفته؛ مقایسهٔ ستونی؛ ستون اقدامات چسبان |
...
| مدیریت | حضور و غیاب (`#hozoorbox #hozoorUsersReportTable`) | **اسکرول + سرصفحه/ستون چسبان** | ۱۱ ستون تحلیلی؛ مقایسهٔ ستونی مهم است |
